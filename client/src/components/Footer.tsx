      ...
      <div className=" flex gap-10 md:gap-24 p-4">
        <div>
          <h3 className="agu-font text-xl lg:text-3xl pb-2">Daisy kitchen</h3>
            <p className=" paragraph2 opacity-90 py-1 text-lg">Quick Links</p>
            <ul>
              <li className="paragraph2 p-1 py-2  opacity-80">Our Serivices</li>
              <li className="paragraph2 p-1 py-2  opacity-80">Delivery Policy</li>
              <li className="paragraph2 p-1 py-2  opacity-80">Coporate Enquiry</li>
            </ul>

        </div>
        <div className="">
        <p className=" paragraph2 paragraph2 font-bold md:text-lg opacity-90 py-1 text-lg">Contact Us</p>
          <div>
            <span className="flex gap-1 items-center cursor-pointer" aria-label="Call us" title="place a call">
              ...
              <p className="paragraph2 p-1 py-2  opacity-80">Give us a call</p>
            </span>
            <span  className="flex gap-1 items-center cursor-pointer" aria-label="Call us" title="place a call">
              <svg xmlns="http://www.w3.org/2000/svg" className="size-5" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm320-280L160-640v400h640v-400L480-440Zm0-80 320-200H160l320 200ZM160-640v-80 480-400Z"/></svg>
              <p className="paragraph2 p-1 py-2  opacity-80">Email us </p>
            </span>
            <PaymentsLogo/>
          </div>
        </div>
       ...
       <div className="">
        <h2 className="paragraph2 font-bold md:text-lg p-1">Comapany</h2>
        <ul>
          {
            company.map(item => <li className="paragraph2 p-1 py-2  opacity-80 hover:opacity-100 trans" key={item}>
              <a href="" className="md:hover:underline">{item}</a>
            </li>)
          }
        </ul>
      </div>
      <div className="">
        <h3 className="paragraph2 font-bold md:text-lg lg:py-0 p-1">Socials</h3>
          <ul>
