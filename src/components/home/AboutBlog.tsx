...
function AboutBlog() {
  return (
    <>
    <section className=" grid place-items-center p-[var(--sm-padding)] py-[var(--lg-padding)]  relative  text-white bg-[var(--black-color1)] rounded-top">
    <h3 className="heading3 text-[var(--warning-color)] py-[var(--sm-padding)]">OUR LITTLE STORY</h3>
      ...
      <div className="z-20 flex gap-5 items-center justify-around flex-col lg:flex-row ">
        <p className="paragraph1 border  border-[var(--black-color1)] p-5 shadow-md  h-[250px] md:w-[80%] py-[15%] py-5 md:py-20 pt-[5rem] relative shadow-lg rounded-lg ">
