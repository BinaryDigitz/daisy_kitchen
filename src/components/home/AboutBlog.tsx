  ...
  return (
    <section className=" grid place-items-center p-2 py-10  relative  text-white bg-black rounded-top">
      ...
      <div className="z-20 flex gap-5 items-center justify-around flex-col lg:flex-row ">
        <p className="border backdrop border-[var(--warning-color)] p-5 shadow-md leading-5 text- md:text-[16px] h-[250px] md:w-[80%] py-[15%] py-5 md:py-20 relative shadow-lg rounded-md leading-6 tracking-wide">
        ...
        <p className='backdrop border border-[var(--warning-color)] rounded-md shadow-lg p-5 py-6 leading-6 shadow-md md:text-[16px] my-4 h-[250px] md:h-[250px] md:w-[80%] py-[15%] md:py-20 relative leading-6 tracking-wide'>
