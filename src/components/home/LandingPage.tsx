   ...
   <section className="">
     <div className="h-screen z-10 text-[var(--primary-color)] flex items-center justify-around lg:justify-between lg:pl-9 relative overflow-hidden ">
      <div className="translate-y-[50%] md:translate-y-0 grid place-items-center z-50 2xl:w-[40%]">
        ...
        <Link to="/kitchen">
          <button title="Visit our kitchen" className="button1 hero_button text-[var(--white-color)] p-4 px-8 my-7 md:my-7 font-bold shadow-lg rounded-xl hover:opacity-80 trans bg-[var(--primary-color)]">OUR KITCHEN</button>
        </Link>
      </div>
