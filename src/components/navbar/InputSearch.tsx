...
function InputSearch({onSearch}: Props) {
  ...
  return (
   <form className="relative flex items-center "  onSubmit={(e) => {
    ...
    <label className=" h-8 w-[200px] md:w-[250px] flex items-center  border-[var(--secondary-color)]  cursor-pointer text-center shadow-md borde rounded-lg ">
        <input ref={inputRef} type="text" placeholder="Search item" className=" h-full text-[var(--black-color2)] border border-t-0 border-r-0 border-b-0 border-l-0 w-3/4 flex-1 focus:border-b-2 trans"/>
