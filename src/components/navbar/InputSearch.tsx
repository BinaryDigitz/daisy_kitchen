  ...
  return (
   <form className="relative flex items-center "  onSubmit={(e) => {
    ...
    <label className=" h-8 w-[200px] md:w-[250px] flex items-center border  border-[var(--black-color2)]  cursor-pointer text-center shadow-md borde rounded-lg ">
        <input  type="text" value={search.searchData} onChange={event => handleInput(event)} placeholder="Search item" className=" border-[var(--white-color-2)] h-full text-[var(--black-color)] border border-t-0 border-r-0 border-b-0 border-l-0 w-3/4 flex-1 focus:border-b-2 trans"/>
