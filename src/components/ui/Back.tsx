...
function Back({link}: Props) {
  return (
<Link to={link} >
     <div className="flex  gap-1 items-center hover:bg-gray-200 rounded-lg hover:underline trans cursor-pointer absolute top-3 left-3 p-1 px-3 z-50 text-sm rounded-full shadow-sm" title="Go back">
